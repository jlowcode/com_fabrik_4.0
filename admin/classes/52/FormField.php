 ...
 *
 * Fabrik: J!5.2 FormField with Fabrik repeat element modifications
...
abstract class FormField implements DatabaseAwareInterface, CurrentUserInterface
{
    ...
    public function setup(\SimpleXMLElement $element, $value, $group = null)
    {
		...
		// FABRIK = Allow for repeatable elements
...
*/
    ...
    protected function getName($fieldName)
    {
		...
		// FABRIK elements that are repeatable need to have their repeat count added to the name
		if ($this->repeat)
		{
			$name .= '[' . $repeatCounter . ']';
		}
