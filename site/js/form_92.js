...
const switchStatusValue = function (status) {
    initial_status = jQuery("#edu_projetos___status input[type='radio']:checked")
...
setTimeout(() => {
    let initial_status = jQuery("#edu_projetos___status input[type='radio']:checked").val();
    
    if (initial_status == undefined){
        initial_status = jQuery("#edu_projetos___status")[0].innerText;
...
jQuery("*[id^='edu_projetos___status_input_']").on('click', function () {
