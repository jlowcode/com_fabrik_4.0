...
*/
        ...
        b.all = function (f) {
            ...
            return k.done
                ...
                : new b(function (m, n) {
                      ...
                      var y = [],
                          G = 0;
                      do y.push(void 0), G++, d(k.value).F(u(y.length - 1), n), (k = g.next());
                      while (!k.done);
                  });
        };
        return b;
    ...
    p("Map", function (a) {
        ...
        function d(g, k) {
            ...
            if (n && r(g.h, m))
                for (g = 0; g < n.length; g++) {
                    var u = n[g];
                    if ((k !== k && u.key !== u.key) || k === u.key) return { id: m, list: n, index: g, s: u };
                }
        ...
        e.prototype.set = function (g, k) {
            ...
            m.s ? (m.s.value = k) : ((m.s = { next: this.g, v: this.g.v, head: this.g, key: g, value: k }), m.list.push(m.s), (this.g.v.next = m.s), (this.g.v = m.s), this.size++);
            return this;
        };
    ...
    p("Array.prototype.copyWithin", function (a) {
        ...
        return a
            ...
            : function (c, d, e) {
                  ...
                  else for (e = Math.min(e, h + d - c), c += e - d; e > d; ) --e in this ? (this[--c] = this[e]) : delete this[--c];
                  return this;
              };
    });
    ...
    var Ha = { 1: "1.0", "1.0": "current", "1.1": "upcoming", "1.2": "testing", 41: "pre-45", 42: "pre-45", 43: "pre-45", 44: "pre-45", 46: "46.1", "46.1": "46.2", 48: "48.1", current: "51", upcoming: "52" };
    var Ia;
    function J(a, b) {
        this.g = b === Ja ? a : "";
    }
    ...
    function Oa(a) {
        if (void 0 === Ia) {
            ...
            if (c && c.createPolicy) {
                try {
                    b = c.createPolicy("goog#html", { createHTML: za, createScript: za, createScriptURL: za });
                } catch (d) {
    ...
    function L(a) {
        ...
        var b;
        a instanceof L
            ? ((this.l = a.l), fb(this, a.j), (this.o = a.o), (this.g = a.g), gb(this, a.u), (this.h = a.h), hb(this, ib(a.i)), (this.m = a.m))
            : a && (b = String(a).match(db))
            ? ((this.l = !1), fb(this, b[1] || "", !0), (this.o = M(b[2] || "")), (this.g = M(b[3] || "", !0)), gb(this, b[4]), (this.h = M(b[5] || "", !0)), hb(this, b[6] || "", !0), (this.m = M(b[7] || "")))
    ...
    function Lb() {
        if (A.Promise && A.Promise.resolve) {
            ...
            Ib = function () {
                var b = Mb;
                "function" !== typeof A.setImmediate || (A.Window && A.Window.prototype && ((Xa && K && 0 < K.brands.length) || -1 == $a().indexOf("Edge")) && A.Window.prototype.setImmediate == A.setImmediate)
                    ? (Ab || (Ab = Bb()), Ab(b))
                    : A.setImmediate(b);
            };
    }
