...
<form class="fabrikForm" action="<?php echo $this->table->action; ?>" method="post" id="<?php echo $this->formid; ?>" name="fabrikList">
	<div class="container-fluid">
		<div class="<?php echo $this->params['show-table-filters'] === '6' ? 'row' : ''; ?>">
			<div class="<?php echo $this->params['show-table-filters'] === '6' ? 'col-sm-12' : ''; ?>">
				<?php
				if ($this->hasButtons) :
		...
		<div class="<?php echo $this->params['show-table-filters'] === '6' ? 'row' : ''; ?>">
			<div class="<?php echo $this->params['show-table-filters'] === '6' ? 'col-md-12 col-lg-3' : ''; ?>">
				<?php
				if ($this->showFilters) {
				...
				<div class="fabrikList" id="list_<?php echo $this->table->renderid; ?>">
					...
					foreach ($this->rows as $groupedBy => $group) : ?>
						...
						<div class="fabrik_groupdata">
							...
							endforeach;
							$class = 'fabrik_row span6 oddRow row-fluid';
