...
$showContainer = $_REQUEST['wfl_action'] == 'list_requests' ? 'in' : 'd-none';
?>
...
<!--        orderBySelect-->
    ...
    <table  style="min-height: 400px;" id="tblEntAttributes" class="table table-hover table-bordered <?php $this->list->class; ?>">
        <thead>
