...
<form class="fabrikForm form-search" action="<?php echo $this->table->action; ?>" method="post" id="<?php echo $this->formid; ?>" name="fabrikList" style="width: 100%;">
    ...
    <div class="<?php echo $this->params['show-table-filters'] === '6' ? 'row' : ''; ?>" style="width: 100%;">
        ...
        <div class="filterContent <?php echo $this->params['show-table-filters'] === '6' ? ' col-sm-12 col-md-3 col-xl-2' : ''; ?>">
            <?php
        ...
        <div class="listContent fabrikDataContainer<?php echo $this->params['show-table-filters'] === '6' ? ' col-sm-12 col-md-9 col-xl-10' : ''; ?>">
