...
<div class="btn-group">
	...
	<?php if ($this->showCSV) {?>
		<a href="#" class="btn csvExportButton">
			<?php echo FabrikHelperHTML::icon('icon-upload', Text::_('COM_FABRIK_EXPORT_TO_CSV')); ?>
		</a>
	<?php }?>
	...
	<?php if ($this->showCSVImport) {?>
		<a href="<?php echo $this->csvImportLink;?>" class="btn csvImportButton">
			<?php echo FabrikHelperHTML::icon('icon-download', Text::_('COM_FABRIK_IMPORT_FROM_CSV')); ?>
		</a>
	<?php }?>
