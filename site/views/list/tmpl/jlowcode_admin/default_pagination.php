...
// Commented out because the overide already exists at the template (templates/g5_jlowcode/html/layouts/com_fabrik/pagination/fabrik-pagination-links.php)
/*function fabrik_pagination_list_render($data, $listRef) {
	return true;
}*/
...
if (!function_exists('fabrik_pagination_item_active'))
{
	function fabrik_pagination_item_active(&$item, $listid)
	{
		...
		return '<a ' . $rel . 'title="' . $item->link . '" href="' . $item->link . '">' . $item->text . '</a>';
	}
}
